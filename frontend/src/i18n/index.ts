  ...
  zh: {
    translation: {
      ...
      user: {
        ...
        accountLimitReached: '账户数量已达上限，您当前已使用 {{current}} 个账户，您的会员计划最多允许 {{max}} 个账户。',
      ...
      strategies: {
        ...
        clearLogs: '清除日志',
        noLogs: '暂无日志',
        needMT5Account: '请先添加MT5账户',
        selectMT5Account: '选择MT5账户',
        limitReached: '策略数量已达上限',
        limitReachedMessage: '您当前已使用 {{current}} 个策略，您的会员计划最多允许 {{max}} 个策略。',
        upgradeMembership: '升级会员',
      },
      analytics: {
        title: '数据分析',
      ...
      pricing: {
        ...
        scanQRCode: '扫描二维码支付',
        order: '订单',
        demoNote: '这是一个演示。点击"模拟支付"来模拟成功的支付。',
        mockPayment: '模拟支付',
        planFree: '免费版',
        planBasic: '基础版',
        planPro: '专业版',
  ...
  en: {
    translation: {
      ...
      user: {
        ...
        accountLimitReached: 'Account limit reached. You are currently using {{current}} accounts, your membership plan allows a maximum of {{max}} accounts.',
      ...
      strategies: {
        ...
        needMT5Account: 'Please add MT5 account first',
        selectMT5Account: 'Select MT5 Account',
        limitReached: 'Strategy limit reached',
        limitReachedMessage: 'You are currently using {{current}} strategies, your membership plan allows a maximum of {{max}} strategies.',
        upgradeMembership: 'Upgrade Membership',
      },
      analytics: {
        title: 'Analytics',
      ...
      pricing: {
        ...
        order: 'Order',
        demoNote: 'This is a demo. Click "Mock Payment" to simulate a successful payment.',
